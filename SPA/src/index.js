      ...
      personFacade.getPersonById(input)
          .then(person => {
            ...
            const personRow = `
                    ...
                    <td>${person.count}</td>
                    <td>
                      <button class="btn-primary small" title="edit" id="${person.id}" data-toggle="modal" data-target="#editMyModal">Edit</button>
                      <button class="btn-danger small" title="delete"  id="${person.id}">Delete</button>
                    </td>
                    </tr>
                    `;
